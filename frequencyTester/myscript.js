...
var timePerFrame = getOrDefault(params, "fps", 60) / 1000
var timePerUpdate = getOrDefault(params, "rpm", 60) / 1000
...
var oldRadius = 0
var lines = []
console.log(timePerFrame, timePerUpdate)
setInterval(draw, timePerFrame)
setInterval(update, timePerUpdate)
