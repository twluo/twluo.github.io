...
canvas.addEventListener('click', toggleSolution, false)

document.body.onkeyup = function (e) {
    if (e.key == " " || e.kcode == "Space" || e.keyCode == 32) {
        toggleSolution() 
    }
